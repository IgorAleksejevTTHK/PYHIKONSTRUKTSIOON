...
if __name__ == "__main__":
    ...
    c1 = cart(shop1)
    print(c1.add_product(p1, 4)) #milk 4
    print(shop1.product_counts) # остатки после 1 покупки
    print(c1.products) # содержимое корзины
    print(c1.add_product(p1a, 4)) # milk 4, тот же ID
    print(c1.products) # содержимое корзины
    c1.add_product(p1, 3) # еще 3 молока
    print(c1.get_total_price()) # общая стоимость в корзине (8 * 80)
    print(p1 == p1a) # True тк ID одинаковое
